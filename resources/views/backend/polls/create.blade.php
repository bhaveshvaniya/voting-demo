...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <div class="row">
            <div class="col-md-12">
            <form action="{{ route('backend.polls.store') }}" method="POST" id="addForm" enctype="multipart/form-data">
                @csrf
            <!-- Default box -->
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <input id="polls_name" type="text" name="polls_name" value="{{ old('polls_name') }}" class="form-control @error('polls_name') is-invalid @enderror" placeholder="Enter Polls Name">
                                @error('polls_name')
                        ...
                        <div class="col-sm-6">
                            <div class="form-group required">
                                ...
                                <div class="input-group date" id="start_date" data-target-input="nearest">
                                    <input type="text" name="start_date" value="{{ old('start_date') }}" id="calibrationDatetime" class="form-control datetimepicker-input @error('start_date') is-invalid @enderror" data-target="#start_date" onkeydown="return false"  placeholder="Enter Start Date"  />
                        ...
                        <div class="col-sm-6">
                            <div class="form-group required">
                                ...
                                <div class="input-group date" id="end_date" data-target-input="nearest">
                                    <input type="text" name="end_date" value="{{ old('end_date') }}" id="calibrationDatetime" class="form-control datetimepicker-input @error('end_date') is-invalid @enderror" data-target="#end_date" onkeydown="return false"  placeholder="Enter End Date"  />
                        ...
                        <div class="col-sm-12">
                            ...
                            <table id="myTable" class=" table order-list">
                                ...
                                <tbody>
                                    <tr>
                                        <td class="col-sm-4">
                                            <input type="text" name="options[][content]" class="form-control" />
                                        </td>
