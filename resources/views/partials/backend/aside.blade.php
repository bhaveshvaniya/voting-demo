        ...
        <div class="sidebar">
            ...
            <nav class="mt-2">
               ...
               with font-awesome or any other icon font library -->
                    ...
                    @hasrole('Admin')
                    <li class="nav-item">
                        <a href="{{ route('backend.polls.index') }}" class="nav-link @isset($asideSelected) @if($asideSelected == 'polls') active @endif @endisset">
                            <i class="nav-icon fas fa-cog"></i>
                            <p>
                                Polls
                            </p>
                    ...
                    @hasrole('Voter')
                    <li class="nav-item">
                        <a href="{{ route('backend.voters.index') }}" class="nav-link @isset($asideSelected) @if($asideSelected == 'polls') active @endif @endisset">
                            <i class="nav-icon fas fa-cog"></i>
                            <p>
                                Voter
                            </p>
