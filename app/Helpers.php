...
if(!function_exists('getAvatar'))
{
    ...
    {           
        ...
        {
            if(file_exists(public_path() . '/uploads/avatar/' . Auth::user()->user_avatar))
            {
                $url = asset('uploads/avatar/' . Auth::user()->user_avatar);
            }
        }
...
if(!function_exists('getThumb'))
{
    ...
    {                
        ...
        if(Auth::user()->user_avatar)
        {
            if(file_exists(public_path() . '/uploads/avatar/thumb/' . Auth::user()->user_avatar))
            {
                $url = asset('uploads/avatar/thumb/' . Auth::user()->user_avatar);
            }
        }
